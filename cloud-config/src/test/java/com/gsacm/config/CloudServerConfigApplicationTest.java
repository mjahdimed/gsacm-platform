...
public class CloudServerConfigApplicationTest {

    @Test
    public void contextLoads() {
        // Test if the application context loads successfully with a specific port and context path
        int testPort = 8081;
        String testContextPath = "/test";

        // Create the SpringApplicationBuilder with the desired configuration
        new SpringApplicationBuilder(CloudServerConfigApplication.class)
                .properties("server.port=" + testPort, "server.servlet.context-path=" + testContextPath)
                .run();

        // Perform your assertions or verifications here
    }
}
